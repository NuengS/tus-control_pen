        ...
        <form method="post">
            <div class="form-group ">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-4">
                        <input class="form-control" type="text" name="emp_id" id="emp_id" autofocus placeholder="รหัสตามบัตรพนักงาน" required>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-3 col-form-label">
                    ...
                    <div class="col-4">
                        <input class="form-control" type="text" name="emp_name" id="emp_name" autofocus placeholder="ชื่อ นามสกุล" required>
                    </div>
                </div>
